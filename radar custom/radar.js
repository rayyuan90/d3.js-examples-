...
var RadarChart = {
  draw: function(id, data, options) {
    ...
    function buildLevels() {
      for (var level = 0; level < config.levels; level++) {
        ...
        vis.levels
          ...
          .attr("x1", function(d, i) { return levelFactor * (1 - Math.sin(i * config.radians / vis.totalAxes)); })  //this algrithem sin cos need study
    ...
    // builds [x, y] coordinates for polygon vertices.
